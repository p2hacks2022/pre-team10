...
class ReelCanvas extends Funvas {
  ...
  void u(double t) {
    c.scale(0.3);
    if (itemsImage.length == 0 && t == 0) {
      for (var i = items.length - 1; i > -1; i--) {
        loadImage(items[i]).then((value) {
          itemsImage.add(value);
        });
      }
    }
...
//       child: MaterialApp(
//           home: Scaffold(body: ReelWidget(ReelController(false))))));
// }
